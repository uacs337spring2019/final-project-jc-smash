...
(function() {
    ...
    function displayAll() {
        ...
        let url = "https://smash-stats.herokuapp.com/?mode=all";
        fetch(url)
            .then(checkStatus)
    ...
    function displayOne() {
        ...
        let url = "https://smash-stats.herokuapp.com/?mode=single&name=" + this.value;
        fetch(url)
            .then(checkStatus)
            .then(function(responseText) {
                let json = JSON.parse(responseText);
    ...
    function loadComments(character) {
        let url = "https://smash-stats.herokuapp.com/?mode=comments&name=" + character;
        fetch(url)
            .then(checkStatus)
            .then(function(responseText) {
                let json = JSON.parse(responseText);
    ...
    function sendComment() {
        ...
        fetch("https://smash-stats.herokuapp.com/?mode=comments", sending)
            .then(checkStatus)
            .then(function(responseText) {
                let json = JSON.parse(responseText);
