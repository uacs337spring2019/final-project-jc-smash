...
(function() {
    ...
    function displayAll() {
        ...
        let url = "http://smashstats.herokuapp.com:process.env.PORT/?mode=all";
        fetch(url)
            .then(checkStatus)
    ...
    function displayOne() {
        ...
        let url = "http://smashstats.herokuapp.com:process.env.PORT/?mode=single&name=" + this.value;
        fetch(url)
            .then(checkStatus)
            .then(function(responseText) {
                let json = JSON.parse(responseText);
    ...
    function loadComments(character) {
        let url = "http://smashstats.herokuapp.com:process.env.PORT/?mode=comments&name=" + character;
        fetch(url)
            .then(checkStatus)
            .then(function(responseText) {
                let json = JSON.parse(responseText);
    ...
    function sendComment() {
        ...
        fetch("http://smashstats.herokuapp.com:process.env.PORT/?mode=comments", sending)
            .then(checkStatus)
            .then(function(responseText) {
                let json = JSON.parse(responseText);
